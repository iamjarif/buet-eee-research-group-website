...
const underlineClass = cn(
  "pointer-events-none absolute inset-x-0 -bottom-px h-px origin-left scale-x-0 bg-current transition-transform duration-300 motion-reduce:hidden",
  hoverEaseClass,
  "group-hover:scale-x-100",
);

const arrowClass = cn(
  "inline-block transition-transform duration-300 motion-reduce:transform-none",
  hoverEaseClass,
